...
export default function HomePage() {
  ...
  // รูปโปรไฟล์ (ใช้รูปจำลองที่โหลดขึ้นชัวร์ๆ ก่อน)
  const profileImage = "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=150&auto=format&fit=crop";
  ...
  return (
    <div className="min-h-screen bg-[#F4F6F8] flex justify-center font-sans pb-24">
      {/* 🌟 ปรับขนาดกลับมาเป็นสมดุลเดิม (sm:max-w-2xl md:max-w-3xl) */}
      <div className="w-full sm:max-w-2xl md:max-w-3xl bg-[#F4F6F8] min-h-screen relative flex flex-col shadow-xl overflow-x-hidden">
        ...
        <main className="px-5 mt-4 flex-1 relative z-10 mb-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Card: หาช่าง / บริการ (ใช้รูปภาพสื่อความหมาย) */}
            <Link href="/services" className="bg-white rounded-[2rem] p-0 flex flex-col overflow-hidden shadow-sm border border-gray-100 active:scale-95 transition-transform group">
              <div className="h-24 md:h-28 w-full bg-slate-100 relative overflow-hidden">
                <img src="https://images.unsplash.com/photo-1581578731548-c64695cc6954?q=80&w=400&auto=format&fit=crop" alt="Services" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
              </div>
              <div className="p-4 md:p-5 text-center flex-1 flex flex-col justify-center bg-white relative z-10 -mt-2 rounded-t-[1.5rem]">
            ...
            {/* Card: งานด่วน / เรียกรถ (ใช้รูปภาพสื่อความหมาย) */}
            <Link href="/win-online" className="bg-white rounded-[2rem] p-0 flex flex-col overflow-hidden shadow-sm border border-gray-100 active:scale-95 transition-transform group">
              <div className="h-24 md:h-28 w-full bg-slate-100 relative overflow-hidden">
                <img src="https://images.unsplash.com/photo-1616423640778-28d1b53229bd?q=80&w=400&auto=format&fit=crop" alt="Delivery" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
              </div>
              <div className="p-4 md:p-5 text-center flex-1 flex flex-col justify-center bg-white relative z-10 -mt-2 rounded-t-[1.5rem]">
