      ...
      <div className="w-full max-w-4xl bg-white min-h-screen shadow-xl relative flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="p-4 md:p-8 space-y-12">
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      ...
                      <input 
                        ...
                        className={`w-full bg-transparent border-b border-gray-300 py-2 text-xl font-black outline-none text-center ${idx === 0 ? 'focus:border-gray-500' : idx === 1 ? 'focus:border-[#00C300]' : 'focus:border-[#F59E0B]'}`} 
                      />
                    </div>
                    
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <label className="text-[10px] font-bold text-gray-400">ระยะเวลา (วัน) {idx === 0 && <span className="text-red-500 ml-1">**</span>}</label>
                        <input 
                          type="number" 
                          min="0"
                          placeholder="เช่น 3" 
                          ...
                          className="w-full bg-white border border-gray-200 rounded-xl px-3 py-2 text-sm font-bold outline-none text-center" 
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <textarea 
                        rows={4} 
                        placeholder={`รายละเอียดแพ็กเกจ ${pkg.name}...`} 
                        value={pkg.content} 
          ...
          <section id="profile" className="scroll-mt-36 pt-8 border-t border-gray-100">
            ...
            <div className="bg-white border border-gray-200 rounded-[2rem] p-6 flex flex-col md:flex-row items-center gap-6 shadow-sm relative overflow-hidden">
              {/* แอบใส่ลายน้ำโลโก้จงเจริญเพื่อความสวยงาม */}
              <div className="absolute right-[-20px] bottom-[-20px] opacity-5 pointer-events-none">
                <img src="/logo.png" className="w-48 h-48 grayscale" />
              </div>
              <div className="w-24 h-24 rounded-full bg-gray-100 border-4 border-[#00C300] overflow-hidden shrink-0 relative z-10">
              ...
              <div className="text-center md:text-left flex-1 relative z-10">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mt-4">
                  <div className="bg-gray-50 px-4 py-2 rounded-xl text-center border border-gray-100"><p className="text-xs text-gray-400 font-bold">รีวิว</p><p className="font-black text-gray-800">⭐ 0.0</p></div>
                  <div className="bg-gray-50 px-4 py-2 rounded-xl text-center border border-gray-100"><p className="text-xs text-gray-400 font-bold">ขายได้</p><p className="font-black text-gray-800">0 ครั้ง</p></div>
